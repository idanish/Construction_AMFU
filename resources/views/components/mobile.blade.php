<div class="offcanvas offcanvas-start w-auto" tabindex="-1" id="sidebarOffcanvas"
    ...
    <div class="offcanvas-body">
        ...
        <aside id="layout-menu" class="menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1 border-top">
                ...
                // Procurements
                $isProcurementsActive = Route::is('finance.procurements.index') ||
                Route::is('finance.procurements.create');
                ...
                <li class="menu-item  list-unstyled {{ $isRequestsActive ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isRequestsActive ? 'text-warning' : '' }}">
                ...
                <li class="menu-item  list-unstyled {{ $isInvoicesActive  ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isInvoicesActive ? 'text-warning' : '' }}">
                        <i class="menu-icon tf-icons bx bx-receipt"></i>
                ...
                <li class="menu-item list-unstyled {{ $isPaymentsActive ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isPaymentsActive ? 'text-warning' : '' }}">
                ...
                <li class="menu-item list-unstyled {{ $isBudgetsActive ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isBudgetsActive ? 'text-warning' : '' }}">
                ...
                <li class="menu-item list-unstyled {{ $isReportsActive ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isReportsActive ? 'text-warning' : '' }}">
                ...
                <li class="menu-item list-unstyled {{ $isUsersActive ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isUsersActive ? 'text-warning' : '' }}">
                ...
                <li class="menu-item list-unstyled {{ $isRolesActive ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isRolesActive ? 'text-warning' : '' }}">
                ...
                <li class="menu-item list-unstyled {{ $isSettingsActive ? 'active open' : '' }}">
                    <a href="javascript:void(0);"
                        class="menu-link menu-toggle {{ $isSettingsActive ? 'text-warning' : '' }}">
