...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        // Reports
        $isReportsActive = Route::is('reports.requests') || Route::is('reports.finance') || Route::is('reports.procurement') || Route::is('reports.audit');

        // Users Management
        $isUsersActive = Route::is('admin.user-management') || Route::is('admin.register') || Route::is('admin.deleted-users');
        ...
        // Settings
        $isSettingsActive = Route::is('profile.settings') || Route::is('audit.logs.index') || Route::is('settings.backup&restore');
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item {{ Route::is('finance.payments.index') ? 'active' : '' }}">
                        <a href="{{ route('finance.payments.index') }}" class="menu-link">
                            <i class="menu-icon bi bi-credit-card-2-back"></i>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item {{ Route::is('finance.budgets.index') ? 'active' : '' }}">
                        <a href="{{ route('finance.budgets.index') }}" class="menu-link">
                            <i class="menu-icon bi bi-currency-dollar"></i>
        ...
        @canany(['read-user', 'create-user', 'delete-user', 'read-role', 'create-role', 'read-department', 'create-department'])
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text">Management</span></li>
            ...
            <li class="menu-item list-unstyled {{ $isDepartmentsActive ? 'active open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle {{ $isDepartmentsActive ? 'text-warning' : '' }}">
