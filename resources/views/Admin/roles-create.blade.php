                                    ...
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input group-checkbox" type="checkbox" id="selectAll{{ str_replace(' ', '', $groupName) }}">
                                                <label class="form-check-label" for="selectAll{{ str_replace(' ', '', $groupName) }}">
                                                    Select All
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                @foreach ($groupPermissions as $permission)
                                                    <div class="col-md-6 col-lg-4 mb-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="{{ $permission->name }}" id="{{ $permission->name }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        groupCheckboxes.forEach(groupCheckbox => {
            const permissionCheckboxes = groupCheckbox.closest('.card').querySelectorAll('.permission-checkbox');
