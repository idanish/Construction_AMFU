...
<div class="container">
    ...
    <form method="GET" action="{{ route('audit.logs.index') }}" class="mb-3">
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="text" name="subject_type" class="form-control" placeholder="Filter by Subject" value="{{ request('subject_type') }}">
            </div>
            <div class="col-md-2">
    ...
    <!-- Export Buttons -->
    <div class="mb-3">
        <a href="{{ route('audit.logs.export', request()->all()) }}" class="btn btn-success">Download Logs (Excel)</a>
        <a href="{{ route('audit.logs.exportFull') }}" class="btn btn-danger">Download Full Logs (Excel)</a>
    </div>
