                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('finance.budgets.index') }}" class="menu-link">
                                    <div data-i18n="Notifications">All Budgets</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('budgets.create') }}" class="menu-link">
                                    <div data-i18n="User-Management">Add Budgets</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('finance.invoices.index') }}" class="menu-link">
                                    <div data-i18n="Notifications">All Invoices</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('invoices.create') }}" class="menu-link">
                                    <div data-i18n="User-Management">Add Invoices</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('finance.payments.index') }}" class="menu-link">
                                    <div data-i18n="Notifications">All Payments</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('payments.create') }}" class="menu-link">
                                    <div data-i18n="User-Management">Add Payments</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('finance.procurements.index') }}" class="menu-link">
                                    <div data-i18n="Notifications">All Procurements</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('procurements.create') }}" class="menu-link">
                                    <div data-i18n="User-Management">Add Procurements</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('settings.backup&restore') }}" class="menu-link">
                                    <div data-i18n="Notifications">Backup & Restore</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('settings.security') }}" class="menu-link">
                                    <div data-i18n="User-Management">Setting</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                        <div class="mb-2 mb-md-0">
                            ...
                            , made with ❤️ by
                            <a href="#" target="_blank" class="footer-link fw-bolder">Fiances Module</a>
                        </div>
                    </div>
                </footer>
                <!-- / Footer -->
