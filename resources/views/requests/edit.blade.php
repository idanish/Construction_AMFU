            ...
            <div class="col-md-8 offset-md-2">
                ...
                <form action="{{ route('requests.update', $requestModel->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type" id="typeGeneral"
                                    value="general" {{ old('type', $requestModel->type) === 'general' ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type" id="typePrivate"
                                    value="private" {{ old('type', $requestModel->type) === 'private' ? 'checked' : '' }}>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="5" required>{{ old('description', $requestModel->description) }}</textarea>
                        @error('description')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="replace_attachments"
                                id="replaceAttachments" value="1">
                        ...
                        <div class="upload-box" id="uploadBox">
                            ...
                            <p>Drag & Drop file here or click to upload <br>
                                .jpg, .jpeg, .png, .pdf, .doc, .docx Max: 2 MB</p>
